 ...
 * @author WASO Team
 */
// @WebServlet(name = "ServiceObjetMetierServlet", urlPatterns =
// {"/ServiceObjetMetier"})
public class ServiceObjetMetierServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DBConnection connection = new DBConnection(this.getInitParameter("JDBC-Client-URL"),
                    this.getInitParameter("JDBC-Client-User"), this.getInitParameter("JDBC-Client-Password"), "CLIENT",
                    "COMPOSER");
            ...
            if ("getListeClient".equals(som)) {
            ...
            } else if ("rechercherClientParClientID".equals(som)) {

                String clientIDParametre = request.getParameter("clientID");
                if (clientIDParametre == null) {
                    throw new ServiceException("Paramètres incomplets");
                }
                Integer clientID = Integer.parseInt(clientIDParametre);

                service.rechercherClientParClientID(clientID);
                ...
                String ville = request.getParameter("ville"); // la ville peut etre null
