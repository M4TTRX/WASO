...
public class ServiceObjetMetierServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DBConnection connection = new DBConnection(this.getInitParameter("JDBC-Personne-URL"),
                    this.getInitParameter("JDBC-Personne-User"), this.getInitParameter("JDBC-Personne-Password"),
                    "PERSONNE");
